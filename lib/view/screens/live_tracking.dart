...
class _LiveTrackingState extends State<LiveTracking> {
  ...
  Future<void> LiveTrackingAPIDriver(status) async {
    ...
    if (status == 3) {
      Navigator.pushReplacement(
          context,
          MaterialPageRoute(
              builder: (context) => RideComplete(
                    ddriver_id: widget.driver_id.toString(),
                  )));
    }
  ...
  Future<void> LiveTrackingAPICustomer() async {
    ...
    if (jsondata['status'] == 'on the way') {
      ...
      print("destination!!");
      _currentStep < 3 ? setState(() => _currentStep = 3) : null;
      Navigator.pushReplacement(
          context,
          MaterialPageRoute(
              builder: (context) => RideComplete(
              ...
              child: Stepper(
                ...
                steps: <Step>[
                  ...
                  Step(
                    ...
                    content: Container(
                      child: Text("Driver has reached the Pick Up location.",
                          style: TextStyle(
                              fontSize: 18, fontWeight: FontWeight.w700)),
                    ),
                    isActive: _currentStep >= 0,
                  ...
                  Step(
                    ...
                    content: Container(
                      child: Text("Driver has reached the destination.",
                          style: TextStyle(
                              fontSize: 18, fontWeight: FontWeight.w700)),
                    ),
                    isActive: _currentStep >= 0,
